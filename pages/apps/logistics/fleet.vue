...
const vehicleTrackingData = [
  {
    name: 'DN20231235',
    location: '33, Jinjuyeok-ro 73beon-gil,',
    progress: 100,
    driverName: '김승훈',
  },
  // {
...
const flyToLocation = (index: number) => {
  const geolocation = geojson.features[index].geometry.coordinates
